...
#include "turtlebot3_msgs/msg/detail/goal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtlebot3_msgs::msg::Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtlebot3_msgs::msg::Goal & ros_message)
{
  // Member: pose
  cdr >> ros_message.pose;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlebot3_msgs::msg::Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtlebot3_msgs::msg::Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtlebot3_msgs::msg::Goal *>(
    untyped_ros_message);
...
{
  return &turtlebot3_msgs::msg::typesupport_fastrtps_cpp::_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_msgs, msg, Goal)() {
  return &turtlebot3_msgs::msg::typesupport_fastrtps_cpp::_Goal__handle;
}
