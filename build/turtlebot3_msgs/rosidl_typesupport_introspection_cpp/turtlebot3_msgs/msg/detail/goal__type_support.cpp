...
{
  new (message_memory) turtlebot3_msgs::msg::Goal(_init);
}

void Goal_fini_function(void * message_memory)
{
  auto typed_message = static_cast<turtlebot3_msgs::msg::Goal *>(message_memory);
  typed_message->~Goal();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Goal_message_member_array[2] = {
  {
    ...
    offsetof(turtlebot3_msgs::msg::Goal, pose),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtlebot3_msgs::msg::Goal, flag),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Goal_message_members = {
  ...
  "Goal",  // message name
  2,  // number of fields
  sizeof(turtlebot3_msgs::msg::Goal),
...
{
  return &::turtlebot3_msgs::msg::rosidl_typesupport_introspection_cpp::Goal_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_msgs, msg, Goal)() {
  return &::turtlebot3_msgs::msg::rosidl_typesupport_introspection_cpp::Goal_message_type_support_handle;
}
